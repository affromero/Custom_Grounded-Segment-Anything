...
try:
    ...
    subprocess.check_call([sys.executable, "-m", "pip", "install", "setuptools==69.5.1", "numpy", "torch @ https://download.pytorch.org/whl/cu121/torch-2.1.2%2Bcu121-cp310-cp310-linux_x86_64.whl"])
    import torch
